...
echo ""
echo ""
echo -e "\033[01;31m\033[1;31m\033[5;34;47m                INSTALLATION BEGINS               \033[1;33m \033[0m\033[01;31m$NC"
echo ""
echo ""
# Add Domain
wget https://raw.githubusercontent.com/prjkt-nv404/XRAY-MULTI/main/updated/adddomain.sh && chmod +x adddomain.sh && ./adddomain.sh
#
#install tools/alat
wget https://raw.githubusercontent.com/prjkt-nv404/XRAY-MULTI/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
wget https://raw.githubusercontent.com/prjkt-nv404/XRAY-MULTI/main/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
#install menu
wget https://raw.githubusercontent.com/prjkt-nv404/XRAY-MULTI/main/menu/updatedll.sh && chmod +x updatedll.sh && ./updatedll.sh
#
...
if [[ "$IP" = "" ]]; then
	...
	echo " "
	echo " "
	echo "${success} ... Installation has been completed!! ✔️"
	sleep 3
	clear
	...
	echo "   - Timezone                : Africa/Accra (GMT +7)"  | tee -a log-install.txt
